...
object StopWords {
  ...
  val words = Set(
    ...
    "going", "gone", "got", "gotten", "greetings", "had", "hadn’t", "happens",
    ...
    "little", "look", "looking", "looks", "ltd", "mainly", "many", "may",
    ...
    "specify", "specifying", "still", "sub", "such", "sup", "sure", "t’s",
    ...
    "uses", "using", "usually", "value", "various", "very", "via", "viz", "vs",
    ...
    "won’t", "wonder", "would", "would", "wouldn’t", "yes", "yet", "you",
